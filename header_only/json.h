        ...
        
{
    ...
    if ((buffer_re2c_limit - buffer_re2c) < 5) YYFILL(5);
    yych = *buffer_re2c;
    if (yych <= ':') {
        if (yych <= '!') {
            if (yych <= '\f') {
...
json_parser_40:
    yyaccept = 1;
    marker = ++buffer_re2c;
    if ((buffer_re2c_limit - buffer_re2c) < 3) YYFILL(3);
    yych = *buffer_re2c;
json_parser_41:
    if (yybm[0+yych] & 32) {
        goto json_parser_40;
...
json_parser_45:
    ++buffer_re2c;
    if (buffer_re2c_limit <= buffer_re2c) YYFILL(1);
    yych = *buffer_re2c;
    if (yych <= '/') goto json_parser_11;
    if (yych <= '9') goto json_parser_45;
    goto json_parser_11;
...
@todo Use dedicated error function.
@todo Make sure that end of line is expected.
